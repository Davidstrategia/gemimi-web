...
2. Optimizar rendimiento (lazy loading vídeo, compresión de imágenes)
3. Añadir meta tags Open Graph y Twitter Cards para compartir en redes
4. Testing responsive en múltiples dispositivos
5. Configurar despliegue (Vercel, Netlify o similar)
6. Añadir página de política de privacidad y términos
7. Conectar botones de descarga a las tiendas reales cuando la app esté disponible
